...
function Office() {
  const products = [
    ...
    {
      id: 3,
      name: "Leatherette Study Chair in Scarlet Red Colour ",
      href: "#",
      price: "$89",
      imageSrc:
        "https://www.ulcdn.net/images/products/921328/product/Mika_Chair_Red_LP.jpg?1722319483",
      imageAlt: "Mika Leatherette Study Chair in Scarlet Red Colour",
    },
    {
      id: 4,
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Empire-Design | Office Furniture</title>
      </Helmet>
